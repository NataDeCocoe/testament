    ...
    <form id="r-form" action="" method="post">
        ...
        <div class="d-flex justify-content-center mb-2 pt-5 i-gap w-1 r-input c-height fixed-w">
            <div class="form-floating2 mb-1">
                <input type="text" name="address" class="form-control c-width" id="address" placeholder="Address">
                <div class="invalid-feedback" id="addError"></div>
            </div>
        </div>
        <div class="d-flex justify-content-center mb-2 pt-5 i-gap w-1 r-input c-height fixed-w">
            <div class="form-floating2 mb-1">
                <input type="password" name="password" class="form-control c-width" id="password" placeholder="Enter your password" >
                <div class="invalid-feedback" id="rPass"></div>
            </div>
        </div>
        <div class="d-flex justify-content-center pt-5 i-gap w-1 r-input c-height ">
            <div class="form-floating2">
                <input type="password" name="confirm_password" class="form-control c-width" id="confirmPass" placeholder="Confirm your password" >
                <div class="invalid-feedback" id="conPass"><small><?php htmlspecialchars($error) ?></small></div>
            </div>
        </div>
